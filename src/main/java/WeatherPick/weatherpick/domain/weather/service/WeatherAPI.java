...
public class WeatherAPI {
    public static void main(String[] args) throws IOException {
        /*URL*/
        String urlBuilder = "http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getVilageFcst" + "?" + URLEncoder.encode("serviceKey", StandardCharsets.UTF_8) + "=CQA5Q3GFH8k2apzdKNEWy1cT%2F1rt82qG534rrAZ7fJts7s8ajjS8V1PzKfNp9wbbY7snmpktgwr%2FFN0BtZPqcQ%3D%3D" + /*Service Key*/
                ...
                "&" + URLEncoder.encode("base_date", StandardCharsets.UTF_8) + "=" + URLEncoder.encode("20250407", StandardCharsets.UTF_8) + /*‘21년 6월 28일발표*/
